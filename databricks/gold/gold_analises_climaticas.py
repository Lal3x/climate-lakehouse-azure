...
# MAGIC
# MAGIC **Catálogo:** `climate.gold`
# MAGIC **Fonte:** `climate.silver.climate_unified`
# MAGIC
...
# MAGIC %sql
# MAGIC CREATE CATALOG IF NOT EXISTS CLIMATE
# MAGIC MANAGED LOCATION 'abfss://climate-lading-eastus-001@saclimatedeveastus001.dfs.core.windows.net/';
# MAGIC
# MAGIC CREATE SCHEMA IF NOT EXISTS CLIMATE.GOLD;
# MAGIC
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE climate.gold.perfil_sazonal_mensal_cidade AS
...
# MAGIC     FROM climate.silver.climate_unified
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE climate.gold.perfil_sazonal_mensal AS
# MAGIC WITH diario AS (
# MAGIC     SELECT
# MAGIC         data_observacao,
# MAGIC         id_estacao,
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE climate.gold.perfil_sazonal_estacao AS
...
# MAGIC     FROM climate.gold.perfil_sazonal_mensal_cidade
# MAGIC )
# MAGIC
# MAGIC SELECT
# MAGIC     cidade,
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE climate.gold.anomalia_climatologica_mensal AS
...
# MAGIC FROM climate.gold.perfil_sazonal_mensal_cidade m
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE climate.gold.ranking_meses_extremos AS
# MAGIC SELECT
# MAGIC     cidade,
# MAGIC     ano,
# MAGIC     mes,
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE climate.gold.tendencia_interanual_mensal AS
# MAGIC SELECT
# MAGIC     cidade,
# MAGIC     mes,
